...
export const INITIAL_VEHICLES: Vehicle[] = [
  {
    ...
    type: 'Pickup Truck',
    make: 'Toyota',
    model: 'Hilux 2.8 GD-6 4x4 Double Cab',
    regNumber: 'AFG-8902',
    year: 2024,
    condition: 'Excellent',
    status: 'assigned',
    assignedDriverId: 'drv-001',
    assignedDriverName: 'Tinashe Moyo',
    ...
    color: 'Glacier White',
    notes: 'Equipped with heavy-duty canopy, bullbar, and enterprise GPS tracker.',
  ...
  },
  {
    ...
    type: 'Delivery Van',
    make: 'Mercedes-Benz',
    model: 'Sprinter 519 CDI High-Roof',
    regNumber: 'BZF-1049',
    year: 2023,
    condition: 'Good',
    status: 'assigned',
    assignedDriverId: 'drv-002',
    assignedDriverName: 'Farai Sibanda',
    currentMileage: 78340,
    fuelType: 'Diesel',
    fuelCapacity: 93,
    ...
    notes: 'Primary freight van for IT infrastructure and hardware distribution.',
  ...
  },
  {
    ...
    type: 'SUV',
    make: 'Ford',
    model: 'Everest 3.0 V6 Platinum 4WD',
    regNumber: 'HRE-4421',
    year: 2024,
    condition: 'Excellent',
    status: 'parked',
    ...
    color: 'Meteor Grey',
    notes: 'Executive site inspections & client audit deployment vehicle. Parked in Bay 2.',
  ...
  },
  {
    ...
    type: 'Box Truck',
    make: 'Isuzu',
    model: 'NPR 400 4.5-Ton Enclosed Body',
    regNumber: 'ZW-9921-A',
    year: 2022,
    condition: 'Fair',
    status: 'on repairs and service',
    assignedDriverId: 'drv-003',
    assignedDriverName: 'Tendai Mutasa',
    ...
    notes: 'Currently undergoing 140,000km preventative transmission overhaul at Barloworld Isuzu.',
    createdAt: '2022-08-14T11:00:00.000Z'
  },
  {
    id: 'veh-005',
    type: 'Sedan',
    make: 'Toyota',
    model: 'Corolla Quest 1.8 Prestige',
    regNumber: 'BZF-3310',
    year: 2021,
    ...
    notes: 'Faulty alternator and steering rack hydraulic pressure leak. Awaiting replacement parts PO-2026-089.',
  ...
  },
  {
    ...
    type: 'Minibus',
    make: 'Toyota',
    model: 'Quantum 2.8 GL 14-Seater Commuter',
    regNumber: 'AFG-6601',
    year: 2023,
    condition: 'Good',
    status: 'parked',
    assignedDriverId: 'drv-004',
    assignedDriverName: 'Kudzai Gumbo',
    currentMileage: 53900,
    fuelType: 'Diesel',
    fuelCapacity: 70,
    ...
    color: 'Pure White',
    notes: 'Staff shift shuttle & inter-facility commute vehicle. Parked at Main Gate B.',
    createdAt: '2023-11-12T07:45:00.000Z'
  }
];
...
export const INITIAL_DRIVERS: Driver[] = [
  {
    ...
    licenseNumber: 'DL-ZW-948201',
    licenseClass: 'Class 2 Heavy & Commercial Code 10',
    dateEngaged: '2023-04-12',
    contactNumber: '+263 77 234 8901',
    address: '14 Enterprise Road, Logistics Park, Harare',
    status: 'Active',
    assignedVehicleId: 'veh-001',
    assignedVehicleReg: 'AFG-8902',
    avatar: 'https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?w=150&auto=format&fit=crop&q=80',
    emergencyContact: 'Rutendo Moyo (Spouse) - +263 77 991 2234',
    licenseExpiry: '2028-04-10',
    totalTripsCompleted: 148,
    notes: 'Certified Defensive Driving Instructor (DDI). Pristine 5-year zero incident safety record.',
    createdAt: '2023-04-12T08:00:00.000Z'
  },
  {
    id: 'drv-002',
    fullName: 'Farai Sibanda',
    licenseNumber: 'DL-ZW-837102',
    licenseClass: 'Class 2 Heavy Goods & Articulated',
    dateEngaged: '2022-08-01',
    contactNumber: '+263 71 892 4412',
    address: '77 Samora Machel Avenue, Suite 4B, Harare',
    status: 'Active',
    assignedVehicleId: 'veh-002',
    assignedVehicleReg: 'BZF-1049',
    avatar: 'https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=150&auto=format&fit=crop&q=80',
    emergencyContact: 'Chipo Sibanda (Sister) - +263 71 334 5590',
    licenseExpiry: '2027-08-25',
    totalTripsCompleted: 215,
    notes: 'Lead long-haul cross-border logistics specialist. Hazmat and sensitive equipment certified.',
    createdAt: '2022-08-01T09:00:00.000Z'
  },
  {
    id: 'drv-003',
    fullName: 'Tendai Mutasa',
    licenseNumber: 'DL-ZW-109283',
    licenseClass: 'Class 2 Heavy Rigid & Forklift Ingress',
    dateEngaged: '2023-11-15',
    contactNumber: '+263 78 445 1198',
    address: '12 Airport Way, Hatfield Cargo District, Harare',
    status: 'Active',
    assignedVehicleId: 'veh-004',
    assignedVehicleReg: 'ZW-9921-A',
    avatar: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=150&auto=format&fit=crop&q=80',
    emergencyContact: 'Blessing Mutasa (Brother) - +263 78 221 9904',
    licenseExpiry: '2029-01-14',
    totalTripsCompleted: 94,
    notes: 'Heavy box-truck cargo handler. Scheduled for Isuzu road testing next Tuesday.',
    createdAt: '2023-11-15T08:30:00.000Z'
  },
  {
    id: 'drv-004',
    fullName: 'Kudzai Gumbo',
    licenseNumber: 'DL-ZW-667219',
    licenseClass: 'Class 4 Light Motor Vehicle & Passenger Endorsement',
    dateEngaged: '2024-01-10',
    contactNumber: '+263 73 559 8831',
    address: '45 Simon Mazorodze Industrial Complex, Harare',
    status: 'Active',
    assignedVehicleId: 'veh-006',
    assignedVehicleReg: 'AFG-6601',
    avatar: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?w=150&auto=format&fit=crop&q=80',
    emergencyContact: 'Tariro Gumbo (Spouse) - +263 73 440 1192',
    licenseExpiry: '2028-11-05',
    totalTripsCompleted: 62,
    notes: 'Personnel commuter shuttle driver. High passenger rating (4.95/5.0).',
    createdAt: '2024-01-10T07:15:00.000Z'
  },
  {
    id: 'drv-005',
    fullName: 'Brendan Vance',
    licenseNumber: 'DL-ZW-554109',
    licenseClass: 'Class 4 Light Vehicle',
    dateEngaged: '2024-05-02',
    contactNumber: '+263 77 601 2289',
    address: '89 Borrowdale Road, Harare',
    status: 'On Leave',
    assignedVehicleId: undefined,
    assignedVehicleReg: undefined,
    avatar: 'https://images.unsplash.com/photo-1522075469751-3a6694fb2f61?w=150&auto=format&fit=crop&q=80',
    emergencyContact: 'Sarah Vance (Mother) - +263 77 882 1190',
    licenseExpiry: '2028-09-18',
    totalTripsCompleted: 35,
    notes: 'Relief driver on scheduled annual leave. Returns August 24.',
...
export const INITIAL_TRIP_LOGS: TripLog[] = [
  {
    id: 'trip-001',
    tripCode: 'TRIP-2026-0104',
    dateTime: '2026-08-16T08:30',
    date: '2026-08-16',
    time: '08:30',
    vehicleId: 'veh-001',
    vehicleType: 'Pickup Truck',
    vehicleMake: 'Toyota Hilux 2.8 GD-6',
    regNumber: 'AFG-8902',
    driverId: 'drv-001',
    driverName: 'Tinashe Moyo',
    driverLicenseNumber: 'DL-ZW-948201',
    mileageOut: 45015,
    fuelGaugeOut: 'Full (100%)',
    destination: 'Robert Gabriel Mugabe Int. Airport - Freight Cargo Terminal 3',
    reasonOfTrip: 'Emergency dispatch & customs pickup of Cisco Core Switchgear & Optical Fiber Modules',
    returnDateTime: '2026-08-16T12:45',
    mileageIn: 45200,
    fuelGaugeIn: '3/4 Tank (75%)',
    totalMileage: 185,
    status: 'Completed',
    loggedBy: 'Eleanor Vance (CEO / Admin)',
    loggedByEmail: 'eleanor.vance@comfortbizflow.io',
    loggedByRole: 'ADMIN',
    loggedAt: '2026-08-16T08:25:00.000Z',
    updatedBy: 'Eleanor Vance',
    updatedAt: '2026-08-16T12:50:00.000Z',
    remarks: 'Cargo securely received, signed airway bills delivered to Procurement desk.',
    verifiedBySupervisor: true
  },
  {
    id: 'trip-002',
    tripCode: 'TRIP-2026-0105',
    dateTime: '2026-08-16T09:15',
    date: '2026-08-16',
    time: '09:15',
    vehicleId: 'veh-002',
    vehicleType: 'Delivery Van',
    vehicleMake: 'Mercedes-Benz Sprinter 519 CDI',
    regNumber: 'BZF-1049',
    driverId: 'drv-002',
    driverName: 'Farai Sibanda',
    driverLicenseNumber: 'DL-ZW-837102',
    mileageOut: 78110,
    fuelGaugeOut: '7/8 Tank (87%)',
    destination: 'Chitungwiza Regional Data Facility & Client Staging Campus',
    reasonOfTrip: 'Delivery of 12x Enterprise Server Racks, Power Distribution Units (PDUs) and backup UPS banks',
    returnDateTime: '2026-08-16T15:20',
    mileageIn: 78340,
    fuelGaugeIn: '5/8 Tank (62%)',
    totalMileage: 230,
    status: 'Completed',
    loggedBy: 'David Alvarez (Project Lead)',
    loggedByEmail: 'david.alvarez@comfortbizflow.io',
    loggedByRole: 'PROJECT_LEAD',
    loggedAt: '2026-08-16T09:05:00.000Z',
    updatedBy: 'David Alvarez',
    updatedAt: '2026-08-16T15:30:00.000Z',
    remarks: 'Offloaded with on-site forklift assistance. Signed delivery note PO-2026-078 attached.',
    verifiedBySupervisor: true
  },
  {
    id: 'trip-003',
    tripCode: 'TRIP-2026-0106',
    dateTime: '2026-08-16T13:00',
    date: '2026-08-16',
    time: '13:00',
    vehicleId: 'veh-001',
    vehicleType: 'Pickup Truck',
    ...
    driverLicenseNumber: 'DL-ZW-948201',
    mileageOut: 45200,
    fuelGaugeOut: '3/4 Tank (75%)',
    destination: 'Msasa Industrial Zone - Hardware Fabrication Depot',
    reasonOfTrip: 'Pickup of custom stainless steel server mounting brackets and cable trays',
    ...
    loggedByEmail: 'eleanor.vance@comfortbizflow.io',
    loggedByRole: 'ADMIN',
    loggedAt: '2026-08-16T12:55:00.000Z',
    remarks: 'Vehicle currently en route to destination. Expected return by 17:00.',
    verifiedBySupervisor: true
  },
  {
    id: 'trip-004',
    tripCode: 'TRIP-2026-0103',
    dateTime: '2026-08-15T07:45',
    date: '2026-08-15',
    time: '07:45',
    vehicleId: 'veh-006',
    vehicleType: 'Minibus',
    vehicleMake: 'Toyota Quantum 2.8 GL',
    regNumber: 'AFG-6601',
    driverId: 'drv-004',
    driverName: 'Kudzai Gumbo',
    driverLicenseNumber: 'DL-ZW-667219',
    mileageOut: 53780,
    fuelGaugeOut: 'Full (100%)',
    destination: 'Harare North Tech Corridor Staff Transit Route',
    reasonOfTrip: 'Morning staff commute shuttle - Morning shift engineering team dispatch',
    returnDateTime: '2026-08-15T09:30',
    mileageIn: 53900,
    fuelGaugeIn: '7/8 Tank (87%)',
    totalMileage: 120,
    status: 'Completed',
    loggedBy: 'Marcus Chen (Head of People)',
    loggedByEmail: 'marcus.chen@comfortbizflow.io',
    loggedByRole: 'HR_MANAGER',
    loggedAt: '2026-08-15T07:30:00.000Z',
    updatedBy: 'Marcus Chen',
    updatedAt: '2026-08-15T09:40:00.000Z',
    remarks: 'All 14 staff members safely transported on schedule.',
    verifiedBySupervisor: true
  },
  {
    id: 'trip-005',
    tripCode: 'TRIP-2026-0102',
    dateTime: '2026-08-14T10:00',
    date: '2026-08-14',
    time: '10:00',
    vehicleId: 'veh-003',
    vehicleType: 'SUV',
    vehicleMake: 'Ford Everest 3.0 V6',
    regNumber: 'HRE-4421',
    driverId: 'drv-001',
    driverName: 'Tinashe Moyo',
    driverLicenseNumber: 'DL-ZW-948201',
    mileageOut: 18190,
    fuelGaugeOut: 'Full (100%)',
    destination: 'Norton Industrial Client Site - Smart Grid Substation Alpha',
    reasonOfTrip: 'Executive engineering review & live commissioning audit with Ministry officials',
    returnDateTime: '2026-08-14T17:15',
    mileageIn: 18450,
    fuelGaugeIn: '5/8 Tank (62%)',
    totalMileage: 260,
    status: 'Completed',
    loggedBy: 'Sophia Patel (Finance Director)',
    loggedByEmail: 'sophia.patel@comfortbizflow.io',
    loggedByRole: 'FINANCE_DIRECTOR',
    loggedAt: '2026-08-14T09:45:00.000Z',
    updatedBy: 'Sophia Patel',
